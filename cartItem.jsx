...
class CartItem extends React.Component {
  ...
  increaseQty() {
    console.log("increaseQty -> updating state qty");
    this.setState(
  ...
  decreaseQty() {
    console.log("decreaseQty -> updating state qty");
  ...
  recalculateTotal() {
    console.log("recalculateTotal -> state qty updated");
    console.log("recalculateTotal -> updating state total");
    this.setState(
